...
|:-----------------------------|-----------:|---------:|---------:|
| Baseline A (XGBoost Tabular) | 0.0140136  | 0.695934 | 0.205313 |
| Baseline B (Weather LSTM)    | 0.00893669 | 0.702323 | 0.244745 |
...
**Current best model:** `Baseline A (XGBoost Tabular)` with an AUPRC of **0.0140**.
